...
const CLASSIFICATION_COLOR = {
  Strong: { ring: "#16a34a", glow: "rgba(22,163,74,0.18)", text: "text-green-700", bg: "bg-green-50" },
  Moderate: { ring: "#d97706", glow: "rgba(217,119,6,0.18)", text: "text-amber-700", bg: "bg-amber-50" },
  Weak: { ring: "#ea580c", glow: "rgba(234,88,12,0.18)", text: "text-orange-700", bg: "bg-orange-50" },
  "Insufficient Evidence": { ring: "#dc2626", glow: "rgba(220,38,38,0.18)", text: "text-red-700", bg: "bg-red-50" },
};
    ...
    <div className="inline-flex flex-col items-center" role="meter" aria-valuenow={score} aria-valuemin="0" aria-valuemax="100" aria-label={`Appealability Score: ${score}%, classified as ${classification}`}>
      <div className="relative" style={{ width: size, height: size }}>
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center" aria-hidden="true">
          <span className="font-display font-bold text-ink-900" style={{ fontSize: size * 0.26 }}>
            {displayScore}
            <span className="text-ink-400" style={{ fontSize: size * 0.14 }}>%</span>
          </span>
          {label !== false && (
